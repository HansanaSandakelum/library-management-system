  ...
  return (
    <Router>
      <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100 transition-colors duration-300 relative selection:bg-indigo-500/30">
        ...
        <div className="absolute top-0 inset-x-0 h-96 bg-gradient-to-b from-indigo-100/50 via-purple-100/30 to-transparent dark:from-indigo-900/20 dark:via-purple-900/10 -z-10 pointer-events-none"></div>
